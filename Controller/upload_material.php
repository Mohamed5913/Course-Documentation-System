...
require_once '../Model/MaterialUploadSubject.php';
require_once '../Model/LoggingObserver.php';
require_once '../Model/MaterialUploadObserver.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['material'])) {
        ...
        $subject->notify([
            ...
            header("Location: ../View/course_details.php?id=$course_id&material_success=1");
            exit();
        } else {
            // Redirect with error
            header("Location: ../View/course_details.php?id=$course_id&material_error=1");
            exit();
        }
    }
}
