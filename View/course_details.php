...
<body>
    ...
    <main>
        <section id="course-info">
            ...
            <!-- Add Quiz Section -->
            <h3>Quizzes</h3>
            <form action="../Controller/add_quiz.php" method="GET">
            ...
            <?php while ($assignment = $assignments_result->fetch_assoc()): ?>
                <div>
                    ...
                    <form action="../Controller/submissions.php" method="GET">
    ...
    <?php if (isset($_GET['success'])): ?>
        <script>alert('Assignment uploaded successfully!');</script>
    <?php elseif (isset($_GET['error']) && $_GET['error'] === 'upload'): ?>
        <script>alert('Failed to upload assignment file.');</script>
    <?php endif; ?>

    <?php if (isset($_GET['material_success'])): ?>
        <script>alert('Material uploaded successfully!');</script>
    <?php elseif (isset($_GET['material_error'])): ?>
        <script>alert('Failed to upload material.');</script>
    <?php endif; ?>
